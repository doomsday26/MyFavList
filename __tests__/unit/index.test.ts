...
// })
  ...
  it('should create content successfully',async()=>{
    ...
    const result = await ListItemRepo.addToUserList(listItem_payload.userId,listItem_payload.contentId)
    expect(result).toBeDefined();
    expect(result).toHaveProperty('_id')
    expect(result).toHaveProperty('createdAt')
...
it ('should get all the list items',async()=>{
    ...
    const resultListItem1 = await ListItemRepo.addToUserList(listItem_payload.userId, new Types.ObjectId('6647004c04fa3053ea1de21e'))
